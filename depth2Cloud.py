...
def depth_image_to_point_cloud(rgb, depth, scale, K, pose):
    ...
    Z = np.log2(depth.astype(float)) / scale
...
if __name__ == '__main__':
    dataset_folder = Path("/home/asus/Desktop/depth2Cloud/coco")
    ...
    scale_factor = 0.5
    build_point_cloud(os.path.join(dataset_folder), scale_factor, view_ply_in_world_coordinate)